...
現在のcontract digest `0e25c936b62c23a814b941905c2d905b0d761932347e7c443035d86b8a39d56a`は、manifest、schema、template、validator / compilerの内容から決定する。consumer profileはこのdigestをpinし、変更時にdigest、generated docs、CHANGELOG、互換性宣言が揃わなければCIを失敗させる。
